		...
		try
		{
			...
			String second_line="-------- -- ----------------------------- --- --  ---  -- --- --- --\n";
			 BufferedWriter output = null;
		        File file = new File("C:\\Users\\hp\\Desktop\\HW1\\CSX-358-HW1-16103027.txt");
			...
			while(line!=null)
			{
				...
				outLine+=" ";
				int tot=0,ex=0;
				ex=Integer.parseInt(splitStr[1]);//converting string to integer
				for(int i=1;i<=11;i++)
				{
					...
					tot+=marks;
				}//till now we add marks of all assignments and extra marks
				...
				}//calculate total marks including extra marks
